...
<head>
    ...
    <title>System Settings - MavetCare</title>
    ...
    <style>
        * {
        ...
        .stat-icon.admins { background: #8BC34A; }
        .stat-icon.clients { background: #f59e0b; }
        .stat-icon.registrations { background: #ef4444; }
        ...
        .user-type-client { background: #fef3c7; color: #92400e; }
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Client Users</span>
                        <div class="stat-icon clients">
                            <i class="fas fa-user"></i>
                        </div>
                    </div>
                    <div class="stat-value"><?php echo number_format($clientUsers); ?></div>
                    <div class="stat-change">Pet owners</div>
                </div>
                
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Recent Registrations</span>
                        <div class="stat-icon registrations">
                            <i class="fas fa-user-plus"></i>
                        </div>
                    </div>
                    <div class="stat-value"><?php echo number_format($recentRegistrations); ?></div>
            ...
            <div class="content-grid">
                ...
                <div class="settings-form">
                    <h2 class="section-title" style="margin-bottom: 1.5rem;">System Configuration</h2>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-input" value="+63 912 345 6789" placeholder="Enter contact phone">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select">
                            ...
                            <option>Monday - Saturday: 8:00 AM - 6:00 PM</option>
                            <option>Monday - Sunday: 8:00 AM - 6:00 PM</option>
                        </select>
                    </div>
                                    ...
                                    <?php if (!empty($recentUsers)): ?>
                                        <?php foreach ($recentUsers as $user): ?>
                                            <tr>
                                                ...
                                                <td class="text-sm"><?php echo htmlspecialchars($user['email']); ?></td>
                                                <td class="text-sm">
                                                    <?php 
